...
void CColorCombineDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_COMBO_IMGAE2, m_comboImage2);
	DDX_Control(pDX, IDC_COMBO_IMGAE3, m_comboImage3);
}
...
BOOL CColorCombineDlg::OnInitDialog()
{
	...
	if (nIndex == 0)
	{
		AfxMessageBox(_T("그레이스케일 영상이 존재하지 않습니다."));
...
void CColorCombineDlg::OnBnClickedOk()
{
	...
	m_pDoc3 = (CRecogBarcodeDoc*)m_comboImage3.GetItemDataPtr(m_comboImage3.GetCurSel());
	CDialogEx::OnOK();
}
